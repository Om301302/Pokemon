/*This class represent an Oddish object that extends from Pokemon and impelements the
* Grass interface.
...
public class Oddish extends Pokemon implements Grass {
  ...
  /**
  * This constructs an Oddish object, where the string "Oddish" is passed into super.
  */
  public Oddish() {
    super("Oddish");
  }
