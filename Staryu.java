/*This class represent a Staryu object that extends from Pokemon and impelements the
* Water interface.
* @author Phillip Huynh
**/
public class Staryu extends Pokemon implements Water {
  /**
  * This constructs a Staryu object, where the string "Staryu" is passed into super.
  */
  public Staryu() {
    super("Staryu");
  }
  ...
  */
  ...
  public String waterGun(Pokemon p) {
    ...
    damage is dealt. */
    int randNumDamage = (int) (Math.random() * 5) + 1;
  ...
  */
  ...
  public String bubbleBeam(Pokemon p){
    ...
    /*A random damage is generated and multplied based on the defending pokemon type, then
    damage is dealt. */
    int randNumDamage = (int) (Math.random() * 2) + 1;
    randNumDamage *= battleTable[this.getType()][p.getType()];
    int damageFinal = (int) randNumDamage;
    p.takeDamage(damageFinal);
