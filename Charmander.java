/*This class represent a Charmander object that extends from Pokemon and impelements the
* Fire interface.
* @author Om Kakadiya
**/
public class Charmander extends Pokemon implements Fire {
  ...
  /**
  * This constructs a Charmander object, where the string "Charmander" is passed into super.
  */
  public Charmander() {
    super("Charmander");
  }
  ...
  */
  ...
  public String ember(Pokemon p) {
    ...
    damage is dealt. */
    int randNumDamage = (int) (Math.random() * 4);
